...
real-time flight tracking app inspired by FlightRadar24, built with React, TypeScript, Vite, and Tailwind CSS, using Leaflet for interactive maps and the OpenSky Network API for live flight data. The UI is powered by shadcn/ui, Radix UI, and Lucide icons, with TanStack Query handling data fetching and caching.
